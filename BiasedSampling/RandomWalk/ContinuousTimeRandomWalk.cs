...
namespace RandomWalks.RandomWalk {
	...
	public class RandomWalkWithDistributionalIncrements<TVertex, TEdge> : SimpleRandomWalk<TVertex, TEdge>, IWeightedRandomWalk<TVertex, TEdge>
	...
	public class ContinuousTimeSimpleRandomWalk<TVertex, TEdge> : SimpleRandomWalk<TVertex, TEdge>, IWeightedRandomWalk<TVertex, TEdge>
		where TEdge : IEdge<TVertex> {
	...
	public class ContinuousTimeRandomWalkWithNegativeExponentialTimeIncrements<TVertex, TEdge> : SimpleRandomWalk<TVertex, TEdge>, IWeightedRandomWalk<TVertex, TEdge>
	   where TEdge : IEdge<TVertex> {
