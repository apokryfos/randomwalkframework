...
namespace GraphSerializationFramework {
	...
	public static class PrefferedDataTypes {
		...
		public static IMutableBidirectionalGraph<int, Edge<int>> GetPrefferedBidirectionalGraphInstance() {
			return Activator.CreateInstance(PrefferedGraphType) as IMutableBidirectionalGraph<int, Edge<int>>;
		}
		public static IMutableBidirectionalGraph<int, Edge<int>> GetPrefferedBidirectionalGraphInstance(bool allowParallelEdges) {
			return Activator.CreateInstance(PrefferedGraphType, allowParallelEdges) as IMutableBidirectionalGraph<int, Edge<int>>;

		}
		public static IMutableBidirectionalGraph<int, Edge<int>> GetPrefferedBidirectionalGraphInstance(bool allowParallelEdges, int vertexCapacity) {
